...
function checkFileExtension(filePath, expectedExtension){
    ...
    if(mainFileExtension != expectedExtension){
        console.log(`Expected Output: File does not have the expected extension. Expected: ${expectedExtension}, Actual: ${mainFileExtension}`)
    }
    else{
        console.log(`Expected Output: File has the expected extension: ${expectedExtension} `);
    }
}
